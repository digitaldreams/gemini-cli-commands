...
1. `design/information_architecture.md` - Page details and purpose
2. `tasks/user_journeys.md` - User needs and pain points

## Output File

Create: `design/wireframes/{{page-name}}.md`
...
- [Other wireframes]: `design/wireframes/[page].md`
