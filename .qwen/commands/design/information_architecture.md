...
1. `tasks/user_journeys.md` - User goals and critical workflows
2. `tasks/requirements.md` - Features and functionality needed
3. `tasks/architecture.md` - Technical capabilities and constraints
4. `tasks/system_model.md` - Data models and relationships
