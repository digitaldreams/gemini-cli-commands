...
- `tasks/requirements.md` - User needs and features
- `tasks/architecture.md` - Technical capabilities
- `@tasks/model_classes_erd.md`
- `@tasks/tasks.md`


Create `tasks/user_journeys.md` that is:
- **Concise**: 500-800 lines max
...
1. **90% shorter** - Focus on insights, not process description
2. **Natural language** - Write like a human, not a template robot
3. **Business impact** - Every problem states what it costs
4. **Honest about assumptions** - Admits when numbers are estimates
5. **Action-focused** - Every section has clear next steps
6. **Skimmable** - Headers and tables make it easy to scan

**WHAT TO REMOVE:**

❌ Technical flow diagrams (unless they explain UX problems)
❌ Exhaustive touchpoint inventories
❌ Repetitive stage descriptions
❌ Fake precision ("< 2.3 minutes")
❌ Obvious opportunities ("make it faster")
...
✅ Validation plan (how to confirm assumptions)
✅ Emotional narrative (tell the story)

**OUTPUT FORMAT:**

Instead of:
"Confirm creation, number of personas created, number of journeys mapped..."

Use:
"Created journey insights document focusing on [X critical flows]. Identified [Y] high-impact problems with solutions. Top priority: [specific fix]. Next step: [validation method]."

---

## The Real Problem

The original template treats UX research like a **compliance exercise** - "fill out all the fields and we're done!"

Good UX research is **detective work**:
