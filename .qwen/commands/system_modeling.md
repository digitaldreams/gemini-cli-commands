...
- `tasks/requirements.md` - Project requirements
- `tasks/architecture.md` - System architecture

## System Modeling Framework:

There are couple of UML diagrams type but make sure you only choose what actually needed to demonstrate the idea. No extra graphs please.
Please do not repeat same scenario on multiple diagram. Only Create 1-3 main flow diagram if needed.
Diagram should be simple. Show only main and hide details.
...
Create Squence diagram if really necessary.
```
